...
var Myprofile = React.createClass({
    ...
    gotoInvite:function (){
<<<<<<< .mine
        // window.location = "/paymentaccepted/?islog=" + is_loggedIn + "&plsid=0"
        window.location ="/build/views/Football/Glory/payment-accepted/payment-accepted.html?islog=" + is_loggedIn
||||||| .r11472
        window.location = "/paymentaccepted/?islog=" + is_loggedIn + "&plsid=0"
=======
...
>>>>>>> .r11749
    ...
    hideSucessMsg: function () {
        ...
        var newUrl = removeURLParameter("build/views/Football/myprofile/myprofile.html?islog=true&status=true", "status");
                                 ...
                                 <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                     <div className="zoola-box col-centered my-profile">
									    ...
									    <div className="myprofile-label"><a href={"/statement/?islog=" + is_loggedIn}>View statement</a> </div>*/}
                                          ...
                                          <div className="myprofile-label pointer-hand" onClick={this.gotoTopup}><a>Quick deposit</a> </div>
                                          <div className="myprofile-label"><a href={"/build/views/Football/Statement/statement.html?islog="+is_loggedIn}>View statement</a> </div>                                                                           
                                          <div className="myprofile-label no-padding-bottom"><a href={"/build/views/Football/withdraw/withdraw.html?islog=" + is_loggedIn}>Request a withdrawal</a> </div>
                                ...
                                <div className="padding-20">
                                      ...
                                      <div className="row">
                                          <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            ...
                                            <div className="myprofile-label"><a href={"/build/views/Football/ChangeTeam/change-team.html?islog=" + is_loggedIn}>Change team</a> </div>
                                            <div className="myprofile-label"><a href={"/build/views/Football/changeAvatar/changeAvatar.html?islog=" + is_loggedIn}>Change avatar</a> </div>
                                            <div className="myprofile-label"><a href={"/build/views/Football/contact_info/contact_info.html?islog=" + is_loggedIn}>My contact info</a> </div>
                                            <div className="myprofile-label no-padding-bottom"><a href={"/build/views/Football/ResponsibleGamble/ResponsibleGamble.html?islog=" + is_loggedIn}>Responsible gambling</a> </div>
                                          </div>
                                      </div>
                                </div>
                          </div>
